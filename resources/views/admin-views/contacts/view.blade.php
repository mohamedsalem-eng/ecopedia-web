    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('Message') }}
                            ...
                            <div class="row "
                                            ...
                                            @if ($contact['reply'] != null)
                                                ...
                                                <div class="flex-start">
                                                    <h6
                                                        ...
                                                        {{ \App\CPU\translate('Subject') }} : </h6>
                                                    <h6>{{ $data['subject'] }}</h6>
                                                </div>
                                                <div class="flex-start">
                                                    <h6
                                                        class="{{ Session::get('direction') === 'rtl' ? 'ml-1' : 'mr-1' }}">
                                                        {{ \App\CPU\translate('Body') }} : </h6>
                                                    <h6>{{ $data['body'] }}</h6>
                                                </div>
                                            @else
                                                <label
                                                    class="badge badge-danger">{{ \App\CPU\translate('No_reply') }}.</label>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mt-4">
                                    <center>
                                        ...
                                        <label
                                            class="badge badge-soft-danger">{{ \App\CPU\translate('Configure_your_mail_setup_first') }}.</label>
                                    </center>
