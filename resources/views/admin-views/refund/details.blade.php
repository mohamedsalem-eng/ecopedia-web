                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row flex-between justify-content-between  flex-grow-1">
                            ...
                            <div class="col-6 col-md-4 mt-2 mt-md-0 text-capitalize">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col-12 col-sm-4">
                                ...
                                @if ($order->seller_is == 'seller' && $order->seller != null)
                                    ...
                                    <span>{{ \App\CPU\translate('seller_email') }} : <a class="text-dark"
                            ...
                            <div class="col-12 col-sm-4">
                                ...
                                <span>{{ \App\CPU\translate('deliveryman_name') }} :
                                    {{ $order->delivery_man != null ? $order->delivery_man->f_name . ' ' . $order->delivery_man->l_name : \App\CPU\translate('not_assigned') }}</span><br>
                                <span>{{ \App\CPU\translate('deliveryman_email') }} :
                                    {{ $order->delivery_man != null ? $order->delivery_man->email : \App\CPU\translate('not_found') }}</span><br>
                                <span>{{ \App\CPU\translate('deliveryman_phone') }} :
                                    {{ $order->delivery_man != null ? $order->delivery_man->phone : \App\CPU\translate('not_found') }}</span><br>
                            </div>
                            <hr>
                            <div class="col-12 col-sm-4">
                                <span>{{ \App\CPU\translate('payment_method') }} :
                                    {{ str_replace('_', ' ', $order->payment_method) }}</span><br>
                                <span>{{ \App\CPU\translate('order_details') }} : </span> <a class="btn btn-primary btn-sm"
                                    href="{{ route('admin.orders.details', ['id' => $order->id]) }}">{{ \App\CPU\translate('click_here') }}</a><br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.business-settings.refund.refund-status-update') }}" id='order_place'
