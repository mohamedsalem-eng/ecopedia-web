                    ...
                    <div class="card-header">
                        <div class="row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-between">
                                ...
                                <div class="mx-1">
                                    <h5 style="color: red;">({{ $notifications->total() }})</h5>
                                </div>
                            </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.notification.edit', [$notification['id']]) }}">{{ \App\CPU\translate('Edit') }}
                                                    </a>
                                                    <a class="dropdown-item delete" href="javascript:"
                                                        id="{{ $notification['id'] }}')">{{ \App\CPU\translate('Delete') }}
                                                    </a>
                                                    <a class="dropdown-item fire" href="javascript:"
                                                        id="{{ $notification['id'] }}')">{{ \App\CPU\translate('fire_notification') }}
                                                    </a>
...
@push('script_2')
    <script>
        ...
        $(document).on('click', '.fire', function() {
            ...
            $.ajax({
                url: "{{ route('admin.notification.fire') }}",
                method: 'POST',
                data: {
                    id: id,
                },
