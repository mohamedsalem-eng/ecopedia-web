                ...
                <form action="{{ route('admin.profile.update', [$data->id]) }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            for="avatarUploader">
                            <img id="viewer" onerror="this.src='{{ asset('assets/back-end/img/user.png') }}'"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel"
                                    ...
                                    {{ \App\CPU\translate('name') }} <i class="tio-help-outlined text-body ml-1"
                                        data-toggle="tooltip" data-placement="top" title="Display name"></i></label>
