        ...
        <div class="card mb-3 mb-lg-5 border-bottom border-right border-left border-top">
            ...
            @php
                ...
                $data = \App\Model\Order::where('order_type', 'default_type')
                    ->where(['order_status' => 'delivered'])
                    ->select(\Illuminate\Support\Facades\DB::raw('COUNT(id) as count'), \Illuminate\Support\Facades\DB::raw('YEAR(created_at) year, MONTH(created_at) month'))
                    ->whereBetween('created_at', [$from, $to])
                    ->groupby('year', 'month')
                    ->get()
                    ->toArray();
        ...
        <div class="row">
            <div class="col-lg-12 mb-3 mb-lg-12">
                ...
                <div class="card h-100">
                    <!-- Header -->
                    <div class="card-header">
                        <h4 class="card-header-title">{{ \App\CPU\translate('Weekly') }}
                            {{ \App\CPU\translate('Report') }} </h4>
                        ...
                        <ul class="nav nav-segment" id="eventsTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="last-week-tab" data-toggle="tab" href="#last-week"
                                    role="tab">
                    ...
                    <div class="card-body card-body-height">
                        @php
                            $orders = \App\Model\Order::where('order_type', 'default_type')
