                        ...
                        <form id="submit-create-role" action="{{route('admin.custom-role.update',[$role['id']])}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="delivery_man_management"
                                            class="form-check-input" id="delivery_man_management" {{in_array('delivery_man_management',(array)json_decode($role['module_access']))?'checked':''}}>
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                            for="delivery_man_management">{{ \App\CPU\translate('delivery_man_management') }}</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="service_management"
                                            class="form-check-input" id="service_management" {{in_array('service_management',(array)json_decode($role['module_access']))?'checked':''}}>
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                            for="service_management">{{ \App\CPU\translate('service_management') }}</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="supplier_management" class="form-check-input"
                                        {{in_array('supplier_management',(array)json_decode($role['module_access']))?'checked':''}}
                                               id="supplier">
                                        <label class="form-check-label" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                               for="supplier">{{\App\CPU\translate('supplier_Management')}}</label>
                                    </div>
                                </div>
                            </div>
