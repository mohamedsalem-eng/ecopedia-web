                ...
                <div class="card">
                    <div class="card-header py-1">
                        ...
                        <a class="btn btn-primary" href="{{ url()->previous() }}"><i
                                class="tio-left-arrow"></i>{{ \App\CPU\translate('back') }}</a>
                    </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel">{{ $file['name'] }}
                                                        </h4>
                                                        <button type="button" class="close"
                                                            data-dismiss="modal"><span
                                                                aria-hidden="true">&times;</span><span
                                                                class="sr-only">{{ \App\CPU\translate('close') }}</span></button>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button class="btn btn-info"
                                                            onclick="copy_test('{{ $file['db_path'] }}')"><i
                                                                class="tio-copy"></i>
                                                            {{ \App\CPU\translate('copy_path') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            for (var i = 0; i < input.files.length; i++) {
                if (input.files && input.files[i]) {
                    ...
                    reader.onload = function(e) {
                        $('#files').append(
                            '<div class="col-md-2 col-sm-4 m-1"><img style="width: 100%;border: 1px solid; border-radius: 10px; max-height:200px;" id="viewer" src="' +
                            e.target.result + '"/></div>');
                    }
