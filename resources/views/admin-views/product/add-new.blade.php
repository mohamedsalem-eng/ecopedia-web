        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form"
                    @if ($is_supplier) action="{{ route('admin.supplier-management.store') }}"
                @else
                action="{{ route('admin.product.store') }}" @endif
            ...
            Swal.fire({
                ...
                $.post({
                    @if ($is_supplier)
                        ...
                        url: " {{ route('admin.supplier-management.store') }} ",
                    @else
