        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form"
                    @if ($is_supplier) action="{{ route('admin.supplier-management.update', $product->id) }}"
@else

action="{{ route('admin.product.update', $product->id) }}" @endif
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="name">{{ \App\CPU\translate('suppliers') }}</label>
                                        <select multiple="multiple"
                                            class="js-example-basic-multiple js-states js-example-responsive
                                             form-control"
                                            name="supplier_ids[]">
                                    ...
                                    <div class="col-md-6">
                                        <label for="name">{{ \App\CPU\translate('product_type') }}</label>
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            name="product_type" required>
                                            <option value="{{ null }}" selected disabled>
                                                ---{{ \App\CPU\translate('Select') }}---</option>
                                            <option value="product" @if ($product->product_type == 'product') selected @endif>
                                                {{ \App\CPU\translate('product') }}</option>
                                            <option value="service" @if ($product->product_type == 'service') selected @endif>
                                                {{ \App\CPU\translate('service') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <label
                                        class="control-label">{{ \App\CPU\translate('Youtube video link') }}</label>
