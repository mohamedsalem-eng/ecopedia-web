                        ...
                        <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                            ...
                            @if ($is_supplier)
                                <div class="col-12 col-md-3">
                                    <a href="{{ route('admin.supplier-management.add-new') }}"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        @if (!$is_supplier)
                                            ...
                                            <th>{{ \App\CPU\translate('Active') }} {{ \App\CPU\translate('status') }}
                                            </th>
                                        @endif
                                        <th style="width: 5px" class="text-center">{{ \App\CPU\translate('Action') }}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    @if (!$p->status)
                                                        <a class="btn btn-primary btn-sm"
                                                            href="{{ route('admin.supplier-management.edit', [$p['id']]) }}">
                                                            <i
                                                                class="tio-edit"></i>{{ \App\CPU\translate('Edit') }}
                                                        </a>
                                                    @else
                                                        <a class="btn btn-primary btn-sm" target="__blank"
                                                            href="{{ route('contacts') }}">
                                                            <i
                                                                class="tio-edit"></i>{{ \App\CPU\translate('request_edit') }}
                                                        </a>
                                                    @endif
                                                    @if ($p->status)
                                                        <a class="btn btn-primary btn-sm"
                                                            href="{{ route('product', ['slug' => $p->slug]) }}">
                                                            <i
                                                                class="tio-globe"></i>{{ \App\CPU\translate('view_product') }}
                                                        </a>
                                                    @endif
                                                @endif
                                                @if (!$is_supplier)
