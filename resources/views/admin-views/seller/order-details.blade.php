                    ...
                    <div class="card-header" style="display: block!important;">
                        <div class="row">
                            ...
                            <div class="col-12 text-right">
                                <div>
                                    <h6 class="text-capitalize" style="display: inline; color: #8a8a8a; ">
                                        {{ \App\CPU\translate('payment') }} {{ \App\CPU\translate('method') }} :</h6>
                                    <h6 class="mx-1" style="display: inline; color: #8a8a8a;">
                                        {{ str_replace('_', ' ', $order['payment_method']) }}</h6>
                                </div>
                                <div>
                                    <h6 style="display: inline; color: #8a8a8a;">{{ \App\CPU\translate('Payment') }}
                                ...
                                <div>
                                    <h6 class="text-capitalize" style="display: inline; color: #8a8a8a; ">
                                        {{ \App\CPU\translate('shipping') }} {{ \App\CPU\translate('method') }} :</h6>
                                    <h6 class="mx-1" style="display: inline; color: #8a8a8a;">
                                        {{ str_replace('_', ' ', $order->shipping->title) }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
