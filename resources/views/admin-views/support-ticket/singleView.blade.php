            ...
            <div class="media pb-4">
                ...
                <div class="media-body {{ Session::get('direction') === 'rtl' ? 'pr-3' : 'pl-3' }}">
                    ...
                    <span class="font-size-ms text-muted">
                        <i
                            class="czi-time align-middle {{ Session::get('direction') === 'rtl' ? 'ml-2' : 'mr-2' }}">{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $ticket['created_at'])->format('Y-m-d h:i A') }}</i></span>
                </div>
            </div>
