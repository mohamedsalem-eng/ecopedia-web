                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{\App\CPU\translate('has_area')}}</th>
                                ...
                                @foreach($shipping_methods as $k=>$method)
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switch">
                                                <input type="checkbox" class="area"
                                                    data-id="{{$method['id']}}"   {{$method->has_area == 1?'checked':''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </td>
...
@push('script')
    <script>
        ...
        $(document).on('change', '.area', function () {
            ...
            $.ajax({
                url: "{{route('admin.business-settings.shipping-method.area-update')}}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
