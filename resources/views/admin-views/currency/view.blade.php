...
@section('content')
    ...
    $default = \App\CPU\Helpers::get_business_settings('system_default_currency');
    @endphp
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-lg-3 mb-3 mb-lg-0">
                                <div class="flex-start">
                                    <div>
                                        <h5>{{ \App\CPU\translate('Currency') }} {{ \App\CPU\translate('table') }}</h5>
                                    </div>
                                    <div class="mx-1">
                                        <h5 style="color: red;">({{ $currencies->total() }})</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
