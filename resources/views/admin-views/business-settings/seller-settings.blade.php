    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('seller_settings') }}</li>
            </ol>
        </nav>

        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h4 class="mb-0 text-black-50">{{ \App\CPU\translate('sales') }} {{ \App\CPU\translate('comission') }}
                    ...
                    <div class="card-body" style="padding: 20px">
                        <form action="{{ route('admin.business-settings.seller-settings.update-seller-registration') }}"
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label {{ Session::get('direction') === 'rtl' ? 'mr-3' : 'ml-3' }}"
                                    for="defaultCheck1">
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="padding: 20px">
                        <form action="{{ route('admin.business-settings.seller-settings.seller-pos-settings') }}"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="seller_pos" type="radio" value="1" id="seller_pos1"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="seller_pos" type="radio" value="0" id="seller_pos2"
        ...
        @include('shared-partials.image-process._image-crop-modal', [
            'modal_id' => 'company-web-Logo',
        ])
        @include('shared-partials.image-process._image-crop-modal', [
            'modal_id' => 'company-mobile-Logo',
        ])
        @include('shared-partials.image-process._image-crop-modal', [
            'modal_id' => 'company-footer-Logo',
        ])
        @include('shared-partials.image-process._image-crop-modal', [
            'modal_id' => 'company-fav-icon',
        ])
    </div>
@endsection
