    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('Website') }}
                    {{ \App\CPU\translate('Info') }} </li>
            </ol>
        </nav>
        ...
        <div class="row" style="padding-bottom: 20px;">
                ...
                <div class="col-12 col-md-5 mb-1">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center"><i class="tio-money"></i>
                                {{ \App\CPU\translate('Currency Symbol Position') }}</h5>
            ...
            <div class="row col-12">
                ...
                <div class="col-12 col-md-6 mb-1">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">{{ \App\CPU\translate('apple_store') }}
                                {{ \App\CPU\translate('Status') }}</h5>
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">{{ \App\CPU\translate('google_play_store') }}
                                {{ \App\CPU\translate('Status') }}</h5>
                        </div>
                        <div class="card-body" style="padding: 20px">
        ...
        <div
            ...
            <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ \App\CPU\translate('company') }}
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="col-md-12">
                        @php($company_phone = \App\Model\BusinessSetting::where('type', 'company_address')->first())
                        <div class="form-group">
                            <label class="input-label">{{ \App\CPU\translate('Address') }}</label>
                            <input class="form-control" type="text" name="company_address"
                                value="{{ @$company_address?->value ?? '' }}" placeholder="New Business">
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="padding-bottom: 20px">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="input-label">{{ \App\CPU\translate('latitude') }}</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="input-label">{{ \App\CPU\translate('longitude') }}</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label
                                class="input-label">{{ \App\CPU\translate('minimum_stock_limit_for_warning') }}</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ \App\CPU\translate('pagination') }}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ \App\CPU\translate('rename_company') }}
                                {{ \App\CPU\translate('copy_right') }} {{ \App\CPU\translate('Text') }}</label>
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="input-label d-inline text-capitalize">{{ \App\CPU\translate('time') }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="input-label d-inline text-capitalize">{{ \App\CPU\translate('country') }}
                            </label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                class="input-label d-inline text-capitalize">{{ \App\CPU\translate('forgot_password_verification_by') }}
                            </label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div class="form-group">
                            <label>{{ \App\CPU\translate('email') }}
                                {{ \App\CPU\translate('verification') }}</label><small style="color: red">*</small>
                            <div class="input-group input-group-md-down-break">
                                <!-- Custom Radio -->
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body" style="padding: 20px">
                                ...
                                @else
                                    @php(
    \Illuminate\Support\Facades\DB::table('business_settings')->insert(['type' => 'colors','value' => json_encode(['primary' => null,'secondary' => null,]),]))
                                    @php($colors = \App\Model\BusinessSetting::where(['type' => 'colors'])->first())
                                    @php($data = json_decode($colors['value']))
                                @endif
                                ...
                                <div class="card-body" style="padding: 20px">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="color" name="announcement_color"
                                            value="{{ $announcement['color'] }}" class="form-control">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body" style="padding: 20px">
                                    ...
                                    <h4>{{ \App\CPU\translate('payment_logos') }}</h4>
                                    <div class="form-group mb-2 mt-2">
                                        <div class="form-group-item ">
                                        <label class="control-label">{{ \App\CPU\translate('logos') }}</label>
                                        <div class="g-items-header">
                                            <div class="row">
                                                <div class="col-md-10">{{ \App\CPU\translate('logos') }}</div>
                                                <div class="col-md-2"></div>
                                            </div>
                                        </div>
                                        @php($logos =  \App\CPU\Helpers::get_business_settings("payment_logos"))
                                            ...
                                            @if (!empty($logos))
                                                @foreach ($logos as $key => $logo)
                                                    <div class="item" data-number="{{ $key }}">
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                    <input type="hidden" value="{{ $logo ?? '' }}" name="payment_logos[{{ $key }}]">
                                                                    <input type="file"
                                                                    value="{{ $logo ?? '' }}"
                                                                    name="payment_logos[{{ $key }}]"
                                                                     placeholder="{{ \App\CPU\translate('logo') }}"
                                                                    class="file-input"
                                                                    accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">

                                                            </div>
                                                            <div class="col-md-5 bg-dark">
                                                                    <img src="{{ asset('storage/app/public/company') }}/{{$logo}}" style="width: 100px">
                                                            </div>
                                                            <div class="col-md-2">
                                            ...
                                            <div class="item" data-number="__number__">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                            ...
                                                            <input type="file" __name__="payment_logos[__number__]"
                                                            placeholder="{{ \App\CPU\translate('logo') }}"
                                                            class="file-input"
                                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
