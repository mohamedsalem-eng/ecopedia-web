                            ...
                            <table style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center" style="width:15%;">{{ \App\CPU\translate('action') }}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                @if ($category->home_status == true)
                                                    <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                        ...
                                                        <span class="legend-indicator bg-success"
                                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;' }}"></span>{{ \App\CPU\translate('active') }}
                                                    </div>
                                                @elseif($category->home_status == false)
                                                    <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                        ...
                                                        <span class="legend-indicator bg-danger"
                                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;' }}"></span>{{ \App\CPU\translate('disabled') }}
                                                    </div>
                                                @endif
                                            </td>
                                            <td>
