...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">{{ \App\CPU\translate('supplier_list') }} <span
                        ...
                        <form action="{{ url()->current() }}" method="GET">
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ \App\CPU\translate('Search') }} {{ \App\CPU\translate('suppliers') }}"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        <th scope="col" style="width: 100px">
                                            {{ \App\CPU\translate('supplier') }} {{ \App\CPU\translate('ID') }}
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($br as $k => $b)
                                        <tr>
                                            ...
                                            <td>{{ $b['name'] }}</td>
                                            <td>
                                                {{ \App\CPU\Helpers::get_exceprt($b['address'] ?? '', 50, '...') }}
                                            </td>
                                            <td>
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('admin.supplier.update', [$b['id']]) }}">
