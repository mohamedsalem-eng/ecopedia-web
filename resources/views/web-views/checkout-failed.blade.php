...
@section('title',\App\CPU\translate('Order Failed'))
                ...
                <div class="card">
                    @if(auth('customer')->check())
                        <div class=" p-5">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 style="font-size: 20px; font-weight: 900">{{\App\CPU\translate('your_order_could_not_be_placed!')}}
                                        !</h5>
                                </div>
                            </div>
                            ...
                            <span>{{\App\CPU\translate('Your order could not have been confirmed')}}</span>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-6">
                                    <a href="{{route('shop-cart')}}"
                                       class="btn btn-danger pull-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                                        {{\App\CPU\translate('check_cart')}}
                                    </a>
                                </div>
                            </div>
                        </div>
