    ...
    <div>
        <h4 class="modal-title product-title">
            <a class="product-title2" href="{{ route('product', $product->slug) }}" data-toggle="tooltip"
                ...
                <i
                    class="czi-arrow-{{ Session::get('direction') === 'rtl' ? 'left mr-2' : 'right ml-2' }} font-size-lg"></i>
            </a>
        </h4>
    </div>
    <div>
                ...
                <form id="add-to-cart-form" class="mb-2">
                    ...
                    @if ($product->product_type != 'service')
                        <div class="row no-gutters">
                            <div class="col-2">
                                <div class="product-description-label mt-2">{{ \App\CPU\translate('Quantity') }}:
                                </div>
                            </div>
                            <div class="col-10">
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        @if ($product->product_type == 'service')
                            <button
                                ...
                                onclick="enquiry()" type="button" style="width:37%; height: 45px">
                                <span class="string-limit">{{ \App\CPU\translate('enquiry') }}</span>
                            </button>
                        @else
