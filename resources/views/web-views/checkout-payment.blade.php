        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <div class="checkout_details mt-3">
                    ...
                    <h2 class="h6 pb-3 mb-2 mt-5">{{ \App\CPU\translate('shipping_method') }}</h2>
                    ...
                    <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body" style="height: 100px">
                                        <button class="btn btn-block click-if-alone" type="button" id="checkout-button">
                                            <i class="czi-card"></i>
                                            {{ \App\CPU\translate('Credit / Debit card ( Stripe )') }}
                                        </button>
                        ...
                        @if (isset($config) && $config['status'])
                            <div class="col-md-6 mb-4" style="cursor: pointer">
                                <div class="card">
                                    <div class="card-body" style="height: 100px">
                                        <button class="btn btn-block click-if-alone" onclick="paytabPayment()"
...
@push('script')
    <script>
        const shippingMethod = "{{ @$choosen_shipping?->shipping_method_id ?? -1 }}" > 0;
    </script>
    ...
    <script>
        function paytabPayment() {

            if (shippingMethod) {
                location.href = '{{ route('paytabs-payment') }}'
            } else {
                showErrorMessage("{{ \App\CPU\translate('select_shipping_method') }}");
