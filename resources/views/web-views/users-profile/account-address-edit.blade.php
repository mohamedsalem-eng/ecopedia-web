...
@section('content')
                        ...
                        <div class="col-12">
                            <form action="{{ route('address-update') }}" method="post">
                                ...
                                <div class="row pb-1">
                                    ...
                                    <input type="hidden" id="is_billing" value="false">
                                    {{-- <div class="col-md-6" style="display: flex">
                                        <!-- Nav pills -->
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="city" required id="city" class="form-control js-example-responsive">
                                            <option value="" disabled>{{ \App\CPU\translate('--select--') }}</option>
                                            @foreach ($area_array as $city)
                                                <option value="{{ $city['id'] }}" {!! $city['id'] == $shippingAddress->city ? 'selected' : '' !!}>
                                                    {{ $city['name'] }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="state"
                                            value="{{ $shippingAddress->state }}" id="own_state" placeholder="" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="own_country">{{ \App\CPU\translate('Country') }}</label>
                                        <input type="text" class="form-control" id="own_country" name="country"
                                            value="{{ $shippingAddress->country }}" placeholder="" required>
                                    </div>
                                </div>
                                <div class="form-row">
    ...
    @push('script')
        ...
        <script
                src="https://maps.googleapis.com/maps/api/js?key={{ \App\CPU\Helpers::get_business_settings('map_api_key') }}&libraries=places&v=3.45.8">
        </script>
        <script>
