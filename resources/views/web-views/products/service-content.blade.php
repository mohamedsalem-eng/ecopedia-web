        ...
        <div class="row" style="direction: ltr">
            ...
            <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                <div class="details">
                    ...
                    {{-- <div class="mb-3">
                        <span
                            class="h4 font-weight-normal text-accent {{ Session::get('direction') === 'rtl' ? 'ml-1' : 'mr-1' }}">
                            {{ \App\CPU\translate('starting_from') }}
                        </span>
                        <span
                    ...
                    <form id="add-to-cart-form" class="mb-2">
                        ...
                        <div
                            class="position-relative {{ Session::get('direction') === 'rtl' ? 'ml-n4' : 'mr-n4' }} mb-3">
                        ...
                        @foreach (json_decode($product->choice_options) as $key => $choice)
                            <div class="row flex-start mx-0">
                                <div
                                    class="product-description-label mt-2 {{ Session::get('direction') === 'rtl' ? 'pl-2' : 'pr-2' }}">
                                    {{ $choice->title }}
                                    :
                                </div>
                                <div>
                        ...
                        {{-- <div class="row no-gutters">
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="input-group input-group--style-2 {{ Session::get('direction') === 'rtl' ? 'pl-3' : 'pr-3' }}"
                                        style="width: 160px;">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            @if (auth('customer')->id())
                                <button
                                    ...
                                    data-target="#enquiryModal" data-toggle="modal" type="button"
                                    style="width:37%; height: 45px">
                                    <span class="string-limit">{{ \App\CPU\translate('send_file') }}</span>
                                </button>
                            @else
                                <a class="btn btn-primary element-center btn-gap-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}"
                                    href="{{ route('customer.auth.login') }}" target="_blank"
                                    style="width:37%; height: 45px">
                                    <span class="string-limit">{{ \App\CPU\translate('send_file') }}</span>
                                </a>
                            @endif
                    ...
                    @if (Session::has('enquiry_success'))
                        <div class="alert alert-success">
                            {{ Session::get('enquiry_success') }}
                        </div>
                        <hr style="padding-bottom: 10px">
                        @php
                            Session::forget('enquiry_success');
                        @endphp
                    @endif
