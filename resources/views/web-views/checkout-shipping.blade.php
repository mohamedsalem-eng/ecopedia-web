                                ...
                                @foreach ($shipping_addresses as $key => $address)
                                    <li class="list-group-item mb-2 mt-2"
                                        ...
                                        <span>{{ \App\CPU\translate('address') }} : {{ $address['address'] }},
                                            {{ $area_list->firstWhere('id', $address['city'])['name'] ?? '' }},
                                            {{ $address['zip'] }},
                                        ...
                                        <div id="collapseThree"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="city"
                                                        {{ $shipping_addresses->count() == 0 ? 'required' : '' }}
                                                        id="city" class="form-control js-example-responsive">
                                                        <option value="" disabled>{{ \App\CPU\translate('--select--') }}
                                                        </option>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="billing_city"
                                                        {{ $billing_addresses->count() == 0 ? 'required' : '' }} id="billing_city"
...
@push('script')
    ...
    <script>
        function proceed_to_next() {
            let billing_addresss_same_shipping = true;
            ...
            $.post({
                ...
                error: function() {
                    toastr.error(
                        '{{ \App\CPU\translate('Please fill all required fields of shipping/billing address') }}', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                }
