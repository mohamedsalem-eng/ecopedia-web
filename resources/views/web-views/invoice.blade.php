...
@php
    ...
    $area_list = \App\CPU\BackEndHelper::area_list();
            ...
            <tr>
                <td valign="top">
                    ...
                    <div class="h4 montserrat-normal-600">
                        ...
                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->shippingAddress ? $area_list->firstWhere('id',  $order->shippingAddress['city'])['name'] : ""}} {{$order->shippingAddress ? $order->shippingAddress['zip'] : ""}}</p>
                ...
                <td valign="top">
                    ...
                    <div class="h4 montserrat-normal-600">
                        ...
                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->billingAddress ? $area_list->firstWhere('id', $order->billingAddress['city'])['name'] : ""}} {{$order->billingAddress ? $order->billingAddress['zip'] : ""}}</p>
