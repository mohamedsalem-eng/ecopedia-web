        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{ route('seller.dashboard.index') }}" aria-label="Front"
                    ...
                    <img class="navbar-brand-logo" style="height: 55px;"
                                ...
                                <div class="col-12 col-sm-6 col-md-12 col-lg-5">
                                    <div class="input-group float-right">
                                        <select name="category" id="category"
                                            class="form-control js-select2-custom mx-1" title="select category"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button id="invoice_close" type="button" class="close" data-dismiss="modal"
                                aria-label="Close">
