                            ...
                            <tr>
                                ...
                                <td class="align-items-center text-center">
                                    <input type="number" data-key="{{ $key }}"
                                        ...
                                        min="1" onkeyup="updateQuantity('{{ $cartItem['id'] }}',this.value,event)">
                                </td>
    ...
    <div class="box p-3">
        <dl class="row text-sm-right">
            ...
            <dd class="col-sm-6 text-right">
                {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($subtotal)) }}</dd>


            <dt class="col-sm-6">{{ \App\CPU\translate('product') }} {{ \App\CPU\translate('discount') }} :</dt>
            <dd class="col-sm-6 text-right">
                {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(round($discount_amount, 2))) }}
            </dd>
            ...
            <dd class="col-sm-6 text-right">
                {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(round($total_tax_amount, 2))) }}
            </dd>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button id="submit_order" type="button" class="btn  btn-primary btn-lg btn-block" data-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button id="payment_close" type="button" class="close" data-dismiss="modal"
                        aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form action="{{ route('seller.pos.order') }}" id='order_place' method="post"
                        ...
                        <div class="form-group col-12">
                            <label class="input-label"
                                for="">{{ \App\CPU\translate('amount') }}({{ \App\CPU\currency_symbol() }})</label>
                        ...
                        <div class="form-group col-12">
                            <button id="order_complete" class="btn btn-primary"
                                type="submit">{{ \App\CPU\translate('submit') }}</button>
                        </div>
                    </form>
                </div>
