        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-12 mb-2 mb-sm-0">
                    ...
                    <span>{{ \App\CPU\translate('the_products_are_shown_in_this_list,_which_quantity_is_below') }}
                        {{ \App\Model\BusinessSetting::where(['type' => 'stock_limit'])->first()->value }}</span>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="card-header">
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-12 col-md-12 col-lg-4">
                                <h5>{{ \App\CPU\translate('product_table') }} <span>({{ $products->total() }})</span>
                                </h5>
                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="width: 5px" class="text-center">{{ \App\CPU\translate('quantity') }}
                                        </th>
