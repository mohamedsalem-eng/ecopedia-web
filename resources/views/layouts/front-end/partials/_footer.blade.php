...
<footer class="page-footer font-small mdb-color pt-3 rtl">
    ...
    <div class="container text-center" style="padding-bottom: 13px;">
        ...
        <!-- Footer links -->
        <div
            class="row text-center {{ Session::get('direction') === 'rtl' ? 'text-md-right' : 'text-md-left' }} mt-3">
            <!-- Grid column -->
                        ...
                        @if ($ios['status'])
                            <div class="{{ Session::get('direction') === 'rtl' ? 'ml-2' : 'mr-2' }} mb-2">
                                <a class="" href="{{ $ios['link'] }}" role="button"><img
                                        src="{{ asset('assets/front-end/png/apple_app.png') }}" alt=""
                        ...
                        @if ($android['status'])
                            <div class="{{ Session::get('direction') === 'rtl' ? 'ml-2' : 'mr-2' }} mb-2">
                                <a href="{{ $android['link'] }}" role="button">
                                    <img src="{{ asset('assets/front-end/png/google_app.png') }}" alt=""
                                        style="height: 40px!important;">
                                </a>
                            </div>
                        @endif
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">{{ \App\CPU\translate('special') }}
                </h6>
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">
                    {{ \App\CPU\translate('account&shipping_info') }}</h6>
            ...
            <!-- Grid column -->
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">{{ \App\CPU\translate('about_us') }}
                </h6>
        ...
        <div class="row justify-content-start align-items-center">
            @forelse ($logos as $logo)
                    <div class="mx-2 my-2 my-lg-0">
                        <img src="{{asset('storage/app/public/company')}}/{{$logo}}" alt="" style="width: 70px">
                    </div>
            @empty
