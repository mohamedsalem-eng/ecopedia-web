...
@php
$business_mode = \App\CPU\Helpers::get_business_settings('business_mode');
@endphp
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                    <i class="fa-supple nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('suppliers') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/supplier*') ? 'block' : 'none' }}">
                                    <li class="nav-item {{ Request::is('admin/supplier/add-new') ? 'active' : '' }}">
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('inHouse_products') }}</span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('service_management'))
                            <li class="nav-item {{ Request::is('admin/service*') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                                    title="">{{ \App\CPU\translate('service_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/service-enquiry*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.service-enquiry.view') }}">
                                    <i class="tio-chat nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ \App\CPU\translate('service_enquiry') }}
                                    </span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section') && $business_mode == 'multi')
                            <li
                        ...
                        @endif
                        @if (\App\CPU\Helpers::module_permission_check('supplier_management') &&
                            auth('admin')->user()->admin_role_id != 1)
                            <li
                                class="nav-item {{ Request::is('admin/supplier-management*') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                                    title="">{{ \App\CPU\translate('Products') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <!-- Pages -->
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/supplier-management/list/in_house') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                    <i class="tio-shop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/supplier-management/list/in_house') ? 'block' : '' }}">
                                    <li
                                        class="nav-item {{ Request::is('admin/supplier-management/list/in_house') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.supplier-management.list', ['supplier']) }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ \App\CPU\translate('Products') }}</span>
                                        </a>
                                    </li>
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('business_settings'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/trace-orders*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.business-settings.trace-orders.index') }}">
                                    <i class="tio-user-big-outlined nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ \App\CPU\translate('trace_orders') }}
                                    </span>
                                </a>
                            </li>
                            <li
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/business-settings/shipping-method/area-cost') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.business-settings.shipping-method.area-cost') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ \App\CPU\translate('area_cost') }}
                                            </span>
                                        </a>
                                    </li>
                                    @if ($business_mode == 'multi')
