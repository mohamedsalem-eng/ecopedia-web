...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/back-end') }}/vendor/fontawesome-free/css/fontawesome.min.css">
    <link rel="stylesheet" href="{{ asset('assets/back-end') }}/css/customCss/dynamicForm/dynamicForm.css">
