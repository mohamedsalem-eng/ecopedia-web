...
class ProductController extends Controller
{
    ...
    {
        $products = ProductManager::get_service_type($request['limit'], $request['offset']);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }
    public function get_featured_services(Request $request)
    {
        $products = ProductManager::get_featured_service_type($request['limit'], $request['offset']);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }
