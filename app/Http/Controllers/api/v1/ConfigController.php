...
class ConfigController extends Controller
{
    ...
    {
        $currency =  Currency::withoutGlobalScopes()->with("translations")->get();
        $social_login = [];
        ...
        return response()->json([
            ...
            'digital_payment' => (Helpers::get_business_settings('digital_payment')['status'] ?? 0),//CHANGED (boolean)
            'cash_on_delivery' => (Helpers::get_business_settings('cash_on_delivery')['status'] ?? 0), //CHANGED (boolean)
            'base_urls' => [
            ...
            'area_list' =>  BackEndHelper::area_list(),
