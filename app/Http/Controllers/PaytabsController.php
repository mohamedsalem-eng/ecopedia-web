...
class PaytabsController extends Controller
{
    public function payment()
    {
        ...
        $data = [
            ...
            "paypage_lang" => "en",
            "callback" => route("paytabs-response"), // Nullable - Must be HTTPS, otherwise no post data from paytabs
            "return" => route("paytabs-response"), // Must be HTTPS, otherwise no post data from paytabs , must be relative to your site URL
            "customer_details" => [
                "name" => $user->f_name,
                "email" => $user->email,
                "phone" => "000000",
    ...
    public function callback_response(Request $request)
    {
        ...
        if (session()->has('payment_mode') && session('payment_mode') == 'app') {
            ...
            if ($is_success){
                ...
                return view('web-views.checkout-failed');
