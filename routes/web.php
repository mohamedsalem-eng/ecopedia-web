...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::post('/service/enquiry', 'ServiceController@submitEnquiry')->name('service.enquiry');
    ...
    Route::get('account-services', 'UserProfileController@account_services')->name('account-services');
    ...
    Route::group(['prefix' => 'service-form', 'as' => 'service-form.'], function () {
        Route::get('{id}', 'UserProfileController@single_service_form')->name('index');
        Route::post('{id}', 'UserProfileController@comment_submit_service_form')->name('comment');
        Route::get('delete/{id}', 'UserProfileController@service_form_delete')->name('delete');
        Route::get('close/{id}', 'UserProfileController@service_form_close')->name('close');
    });
    ...
    Route::group(['prefix' => 'contact', 'as' => 'contact.'], function () {
        ...
        Route::post('refresh', 'WebController@contact_refresh')->name('refresh');
    });
});
