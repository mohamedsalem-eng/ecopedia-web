...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('services', 'ProductController@get_services');
        Route::get('featured-services', 'ProductController@get_featured_services');
    ...
    Route::group(['prefix' => 'service', 'middleware' => 'auth:api'], function () {
        Route::post('/submit', 'ServiceController@submitEnquiry');
        Route::get('get', 'ServiceController@get_support_tickets');
        Route::get('count', 'ServiceController@count');
        Route::get('check', 'ServiceController@check');
        Route::get('conv/{ticket_id}', 'ServiceController@get_support_ticket_conv');
        Route::post('reply/{ticket_id}', 'ServiceController@reply_support_ticket');
    });
