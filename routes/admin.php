...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'brand', 'as' => 'brand.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::post('change-api/{brand?}', 'BrandController@change_api')->name('change-api');
            Route::get('update/{id}', 'BrandController@edit')->name('update');
            Route::post('update/{id}', 'BrandController@update');
            Route::post('delete', 'BrandController@delete')->name('delete');
        });
        Route::group(['prefix' => 'supplier', 'as' => 'supplier.', 'middleware' => ['module:product_management']], function () {
            Route::get('add-new', 'SupplierController@add_new')->name('add-new');
            Route::post('add-new', 'SupplierController@store');
            Route::get('list', 'SupplierController@list')->name('list');
            Route::get('update/{id}', 'SupplierController@edit')->name('update');
        ...
        Route::group(['prefix' => 'service-enquiry', 'as' => 'service-enquiry.', 'middleware' => ['module:service_management']], function () {
            Route::get('view', 'ServiceEnquiryController@index')->name('view');
            Route::post('status', 'ServiceEnquiryController@status')->name('status');
            Route::get('single-enquiry/{id}', 'ServiceEnquiryController@single_enquiry')->name('single-enquiry');
            Route::get('download-file/{id}', 'ServiceEnquiryController@download_file')->name('download-file');
            Route::post('single-enquiry/{id}', 'ServiceEnquiryController@replay_submit')->name('replay');
        });
        Route::group(['prefix' => 'notification', 'as' => 'notification.', 'middleware' => ['module:marketing_section']], function () {
            ...
            Route::post('fire', 'NotificationController@fire')->name('fire');
        ...
        Route::group([
            'prefix' => 'supplier-management', 'as' => 'supplier-management.',
            'middleware' => ['module:supplier_management']
        ], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::post('sku-combination', 'ProductController@sku_combination')->name('sku-combination')->withoutMiddleware('module:product_management');
            Route::get('get-categories', 'ProductController@get_categories')->name('get-categories')->withoutMiddleware('module:product_management');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:business_settings']], function () {
            ...
            Route::group(['prefix' => 'shipping-method', 'as' => 'shipping-method.', 'middleware' => ['module:business_settings']], function () {
                ...
                Route::get('area-cost', 'ShippingMethodController@area_cost')->name('area-cost');
                Route::post('area-cost', 'ShippingMethodController@store_area_cost')->name('area-cost');
                if (\App\CPU\Helpers::get_business_settings('business_mode') == 'multi') {
                ...
                Route::post('area-update', 'ShippingMethodController@area_update')->name('area-update');
            ...
            Route::group(['prefix' => 'trace-orders', 'as' => 'trace-orders.', 'middleware' => ['module:business_settings']], function () {
                Route::get('/', 'TraceOrdersController@index')->name('index')->middleware('actch');;
            });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::post('supplier', 'OrderController@changeSupplier')->name('supplier');
